...
TimingConstraint tc(TimingScope scope, std::vector<Command> preceding, std::vector<Command> following,
                    int latency, int window = 0, std::string note = {}) {
...
std::vector<TimingConstraint> make_hbm_constraints(const Timing& t) {
  ...
  return {
      ...
      tc(TimingScope::PseudoChannel, {Command::ACT}, {Command::ACT}, t.nFAW, 4),
      tc(TimingScope::Sid, {Command::RD, Command::RDA}, {Command::RD, Command::RDA}, t.nCCDS),
      tc(TimingScope::Sid, {Command::WR, Command::WRA}, {Command::WR, Command::WRA}, t.nCCDS),
      ...
      tc(TimingScope::Bank, {Command::ACT}, {Command::ACT}, t.nRC),
      tc(TimingScope::Bank, {Command::ACT}, {Command::RD, Command::RDA}, t.nRCDRD),
      tc(TimingScope::Bank, {Command::ACT}, {Command::WR, Command::WRA}, t.nRCDWR),
      tc(TimingScope::Bank, {Command::ACT}, {Command::PREPB}, t.nRAS),
      tc(TimingScope::Bank, {Command::PREPB}, {Command::ACT}, t.nRP),
      tc(TimingScope::Bank, {Command::RD}, {Command::PREPB}, t.nRTP),
      ...
      tc(TimingScope::PseudoChannel, {Command::REFAB}, {Command::ACT, Command::PREPB, Command::REFPB}, t.nRFC),
      tc(TimingScope::Bank, {Command::RFMPB}, {Command::ACT}, t.nRFMpb),
      tc(TimingScope::PseudoChannel, {Command::RFMAB}, {Command::ACT, Command::PREPB, Command::RFMPB}, t.nRFMab),
...
std::vector<TimingConstraint> make_lpddr_constraints(const Timing& t) {
  ...
  return {
      ...
      tc(TimingScope::Channel, {Command::RD, Command::RDA}, {Command::RD, Command::RDA}, t.nBL),
      tc(TimingScope::Channel, {Command::WR, Command::WRA}, {Command::WR, Command::WRA}, t.nBL),
      // CAS_RD/CAS_WR 是 WCK 同步命令，真正数据命令还需要等待 nCAS/nWCK2CK。
      // 这里的 CAS->RD/WR 约束与 TimingEngine 中的 WCK ready window 是两道独立检查。
      tc(TimingScope::Bank, {Command::CASRD}, {Command::RD, Command::RDA}, std::max(0, t.nCAS)),
      tc(TimingScope::Bank, {Command::CASWR}, {Command::WR, Command::WRA}, std::max(0, t.nCAS)),
      tc(TimingScope::Rank, {Command::RD, Command::RDA}, {Command::RD, Command::RDA}, t.nCCDS),
      tc(TimingScope::Rank, {Command::WR, Command::WRA}, {Command::WR, Command::WRA}, t.nCCDS),
      tc(TimingScope::Rank, {Command::RD, Command::RDA}, {Command::WR, Command::WRA},
         t.nCL + t.nBL + 2 - t.nCWL),
      tc(TimingScope::Rank, {Command::WR, Command::WRA}, {Command::RD, Command::RDA},
         t.nCWL + t.nBL + t.nWTRS),
      tc(TimingScope::Rank, {Command::ACT1}, {Command::ACT1}, t.nRRDS),
      tc(TimingScope::Rank, {Command::ACT1}, {Command::ACT1}, t.nFAW, 4),
      tc(TimingScope::BankGroup, {Command::RD, Command::RDA}, {Command::RD, Command::RDA}, t.nCCDL),
      tc(TimingScope::BankGroup, {Command::WR, Command::WRA}, {Command::WR, Command::WRA}, t.nCCDL),
      tc(TimingScope::BankGroup, {Command::ACT1}, {Command::ACT1}, t.nRRDL),
      tc(TimingScope::Bank, {Command::ACT1}, {Command::ACT1}, t.nRC),
      tc(TimingScope::Bank, {Command::ACT1}, {Command::RD, Command::RDA, Command::WR, Command::WRA}, t.nRCDRD),
      tc(TimingScope::Bank, {Command::ACT1}, {Command::PREPB}, t.nRAS),
      tc(TimingScope::Bank, {Command::PREPB}, {Command::ACT1}, t.nRP),
      tc(TimingScope::Bank, {Command::RD}, {Command::PREPB}, t.nRTP),
      tc(TimingScope::Bank, {Command::WR}, {Command::PREPB}, t.nCWL + t.nBL + t.nWR),
      ...
      tc(TimingScope::PseudoChannel, {Command::RFMPB}, {Command::RFMPB}, t.nRRDL),
      tc(TimingScope::Rank, {Command::REFAB}, {Command::ACT1, Command::PREAB}, t.nRFC),
      tc(TimingScope::Rank, {Command::RFMAB}, {Command::ACT1, Command::PREAB, Command::RFMPB},
         t.nRFMab > 0 ? t.nRFMab : t.nRFC),
      ...
      tc(TimingScope::Channel, {Command::WCKTRAIN}, {Command::ACT1, Command::CASRD, Command::CASWR}, t.nWCKTRAIN),
